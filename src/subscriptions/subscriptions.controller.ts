...
export class SubscriptionsController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns the authenticated user's active subscription, plan details, and billing period info.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Returns all active subscription plans with features and pricing. Public endpoint — no authentication required.',
  })
  @ApiResponse({
    status: 200,
      ...
      example: [
        {
          ...
          highlightedFeatures: ['3 uploads', 'Standard streaming', 'Ads supported'],
        },
        {
          id: 'plan-uuid-pro',
          code: 'PRO',
          ...
          canDownload: true,
          supportLevel: 'priority',
          highlightedFeatures: ['100 uploads', 'Ad-free', 'Downloads', 'Priority support'],
        },
        {
          id: 'plan-uuid-goplus',
          code: 'GO_PLUS',
          ...
          canDownload: true,
          supportLevel: 'priority',
          highlightedFeatures: ['1000 uploads', 'Ad-free', 'Downloads', 'Priority support'],
        },
      ],
    },
  })
  ...
  @ApiOperation({
    summary: 'List billing invoices for the current user',
    description: "Returns a list of past invoices for the authenticated user's Stripe account.",
  })
  @ApiResponse({
    status: 200,
      ...
      examples: {
        mock: {
          ...
          value: {
            ...
            checkoutSessionId: 'cs_mock_abc123',
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid plan code or no active plan found for the requested tier.',
  })
  @ApiResponse({
    status: 409,
    description: '`SUBSCRIPTION_ALREADY_ACTIVE` — already subscribed to this plan.',
  })
  @ApiResponse({
    status: 403,
