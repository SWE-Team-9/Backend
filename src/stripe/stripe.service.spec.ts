  ...
  return {
    ...
    checkout: {
      sessions: {
        create: jest
          .fn()
          .mockResolvedValue({ id: 'cs_123', url: 'https://checkout.stripe.com/cs_123' }),
    ...
    billingPortal: {
      sessions: {
        create: jest
          .fn()
          .mockResolvedValue({ id: 'bps_123', url: 'https://billing.stripe.com/session' }),
      },
    },
    webhooks: {
      constructEvent: jest
        .fn()
        .mockReturnValue({ id: 'evt_123', type: 'invoice.paid', data: { object: {} } }),
    },
  };
}
