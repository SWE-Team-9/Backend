...
describe("RealStripeBillingProvider", () => {
  ...
  beforeEach(() => {
    ...
    provider = new RealStripeBillingProvider(
      ...
      makeConfig({
        ...
        "billing.checkoutSuccessUrl": "https://dev.iqa3.tech/subscriptions/success?session_id={CHECKOUT_SESSION_ID}",
  ...
  describe("subscription operations", () => {
    it("delegates cancelSubscription to StripeService", async () => {
      await provider.cancelSubscription({ providerSubscriptionId: "sub_123", cancelAtPeriodEnd: true });
