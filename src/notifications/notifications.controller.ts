...
export class NotificationsController {
  ...
  @ApiQuery({ name: 'type', required: false, enum: ['LIKE', 'COMMENT', 'FOLLOW', 'REPOST'], description: 'Filter by notification event type' })
  @ApiQuery({ name: 'isRead', required: false, type: Boolean, example: false, description: 'Filter by read status' })
