...
export class RegisterDto {
  ...
  @ApiPropertyOptional({
    example: "03AGdBq...",
    description: "Google reCAPTCHA v3 token (required in production)",
  })
  @IsOptional()
  @IsString()
...
export class LoginDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: "If true, refresh token lifetime is extended to 30 days",
  })
  @IsOptional()
  @IsBoolean()
  remember_me?: boolean;
...
export class ResetPasswordDto {
  @ApiProperty({
    example: "a1b2c3d4e5f6...",
    description: "Password reset token from the email link (valid for 1 hour)",
  })
  @IsString()
...
export class RequestEmailChangeDto {
  ...
  @ApiProperty({
    example: "Passw0rd!",
    description: "Current password to authorise the change",
  })
  @IsString()
  @IsNotEmpty({ message: "Current password is required." })
  current_password!: string;
...
export class ConfirmEmailChangeDto {
  @ApiProperty({
    example: "a1b2c3d4e5f6...",
    description:
      "Email change confirmation token from the link in the confirmation email (valid for 1 hour)",
  })
  @IsString()
...
export class RefreshTokenDto {
  ...
  @IsString()
  @IsNotEmpty({
    message: "refresh_token must not be an empty string if provided.",
  })
